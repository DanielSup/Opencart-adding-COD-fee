	...
	public function index() {
		...
		if (!empty($payment_address)) {
			...
			foreach ($results as $result) {
				// It is my part of source code which ensures that the information about fee for cash on delivery will not be shown if the variable cod_fee is not defined for the selected shipping method.
			...
			foreach ($results as $result) {
				// It is my part of source code which ensures that customer cannot choose cash on delivery as the payment method if the variable cod_fee is not defined for the selected shipping method because in some countries is not possible to pay by cash on delivery.
				if (!isset($this->session->data["shipping_method"]["cod_fee"]) && $result['code'] == 'cod') {
					continue;
				}
				// end of my part
